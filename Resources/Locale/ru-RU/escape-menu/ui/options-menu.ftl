...
ui-options-enable-classic-overlay = Верните интерфейс антагонов из классического режима
...
ui-options-overlay-ghost-fade-distance = Диапазон затухания HUD призрака от мыши
ui-options-overlay-ghost-hide-distance = Диапазон скрытия HUD призрака от мыши
