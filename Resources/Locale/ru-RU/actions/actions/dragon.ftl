devour-action-popup-message-structure = Ваши челюсти впиваются в твердый материал...
devour-action-popup-message-fail-target-not-valid = Это выглядит не особо съедобно.
devour-action-popup-message-fail-target-alive = Вы не можете поглощать еще живых существ!
