...
ui-change-reagent-whitelist-apply = Выводить только { $reagent }

## Text for the apply button when there is no selected reagent

ui-change-reagent-whitelist-apply-missing-reagent = Выбрать реагент

## Text for the reset button

ui-change-reagent-whitelist-resetbutton-text = Сбросить реагент
