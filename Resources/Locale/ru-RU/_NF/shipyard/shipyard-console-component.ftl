...
shipyard-commands-purchase-desc = Создаёт и стыкует при помощи БСС указанный шаттл.
...
shipyard-console-sale-organic-aboard = Весь экипаж должен высадиться. { $name } все ещё на борту.
...
shipyard-console-engine-Tesla = Тёсла
