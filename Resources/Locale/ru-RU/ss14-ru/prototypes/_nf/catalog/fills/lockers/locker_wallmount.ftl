...
ent-LockerWallMaterialsFuelAmeJarFilled = { ent-LockerWallColorAme }
    .suffix = Заполненный, Топливо АМЕ (x2)
...
ent-LockerWallColorSalvageFilled = настенный шкафчик специалиста по утилизации
