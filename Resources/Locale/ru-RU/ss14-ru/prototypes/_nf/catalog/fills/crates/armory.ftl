ent-CrateArmoryRifleGestio = ящик винтовок гестио
    .desc = Содержит два старых прототипа винтовок с очередями и шестью магазинами малой ёмкости. Для открытия требуется доступ к Оружейной.
ent-CrateArmorySMGExpedition = ящик ПП
    .desc = Содержит два мощных пистолета-пулемёта с четырьмя магазинами. Для открытия требуется доступ к Оружейной. Незарегистрированный.
...
ent-CrateArmoryRifleGestioExpedition = ящик винтовок гестио
    .desc = Содержит два старых прототипа винтовок с очередями и шестью магазинами малой ёмкости. Для открытия требуется доступ к Оружейной. Незарегистрированный.
ent-CrateArmoryRifleNovaliteC1Expedition = ящик для винтовки новалит
    .desc = Содержит две гражданские винтовки с шестью магазинами малой ёмкости. Для открытия требуется доступ к Оружейной. Незарегистрированный.
