...
ent-ClothingHandsGlovesCombatNfsdBrown = боевые перчатки ДШ
    .desc = Утепленные перчатки для капрала Департамента Шерифа.
ent-ClothingHandsGlovesCombatNfsdCream = боевые перчатки ДШ
    .desc = Утепленные перчатки для капрала Департамента Шерифа.
