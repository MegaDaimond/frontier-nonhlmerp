...
ent-CrateFunATV = Ящик с квадроциклом
    .desc = Абсолютно облагаемое налогом транспортное средство для перевозки грузов.
...
ent-CrateFunFoamGuns = Ящик Foam Force
    .desc = Содержит четыре винтовки Foam Force, несколько гранат и дополнительные патроны. Или [УДАЛЕНО], или ничего!
