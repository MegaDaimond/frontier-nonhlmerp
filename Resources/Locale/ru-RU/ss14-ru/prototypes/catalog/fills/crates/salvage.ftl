...
ent-CratePartsT3T4 = ящик компонентов 3/4 уровня
    .desc = Содержит 5 случайных компонентов третьего или четвертого уровня для улучшения оборудования.
ent-CratePartsT4 = ящик компонентов 4 уровня
    .desc = Содержит 5 случайных компонентов четвертого уровня для улучшения оборудования.
