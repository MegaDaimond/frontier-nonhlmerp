...
ent-StealResearchObjective = { ent-BaseNinjaObjective }
    .desc = Ваши перчатки могут быть использованы для взлома сервера РНД и кражи его технологий. Если наука буксует, то придется поработать вам.
ent-SpiderChargeObjective = { ent-BaseNinjaObjective }
    .desc = Эта бомба может быть взорвана в определенном месте. Обратите внимание, что бомба не сработает в другом месте!
ent-NinjaSurviveObjective = Выжить
    .desc = Вы не будете хорошим ниндзя, если умрете, не так ли?
