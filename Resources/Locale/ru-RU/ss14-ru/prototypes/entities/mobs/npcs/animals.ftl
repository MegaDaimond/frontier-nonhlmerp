...
ent-MobGoat = коза
    .desc = Ее позвоночник состоит из длинных острых сегментов, неудивительно, что она такая ворчливая.
ent-MobGoose = гусь
    .desc = Его желудок и разум - загадка, недоступная человеческому пониманию.
ent-MobGorilla = горилла
    .desc = Крушит, ревет, выглядит круто. Не стойте рядом с ней.
...
ent-MobBaseAncestor = генетический предок
    .desc = Генетический бипедальный предок... э-э... чего-то. Да, на станции определенно есть что-то, произошедшее от этого, чем бы оно ни было.
...
ent-MobGuidebookMonkey = тренировочная обезьяна
    .desc = Специально обученная обезьяна, чья единственная цель в жизни - чтобы вы кликнули на нее. Можно ли считать, что обезьяна преподала вам урок?
ent-MobMouse = мышь
    .desc = Пии!
