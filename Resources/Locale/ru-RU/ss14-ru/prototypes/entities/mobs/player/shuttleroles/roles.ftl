...
ent-RandomHumanoidVisitorResearchAssistant = посетитель научный ассистент роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorScientist = посетитель ученый роль призрака
    .desc = { "" }
...
ent-RandomHumanoidVisitorBotanist = посетитель ботаник роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorBoxer = посетитель боксер роль призрака
    .desc = { "" }
...
ent-RandomHumanoidVisitorMime = посетитель мим роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorReporter = посетитель репортер роль призрака
    .desc = { "" }
...
ent-RandomHumanoidPirateCaptainScooner = пират капитан роль призрака
    .suffix = scooner
    .desc = { "" }
ent-RandomHumanoidVisitorBlackmarketeer = посетитель торговец черного рынка роль призрака
    .desc = { "" }
