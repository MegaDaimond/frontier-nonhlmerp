ent-ClothingOuterSuitBomb = саперный костюм
...
ent-ClothingOuterSuitSpaceNinja = костюм космического ниндзя
    .desc = Этот черный, технологически продвинутый, кибернетически усиленный костюм дает множество способностей, таких как невидимость или телепортация.
ent-ClothingOuterSuitChicken = костюм цыпленка
    .desc = Бок-бок-бок!
ent-ClothingOuterSuitShrineMaiden = наряд служительницы храма
    .desc = Так и хочется пойти и разобраться с каким-нибудь проблемным екаем.
