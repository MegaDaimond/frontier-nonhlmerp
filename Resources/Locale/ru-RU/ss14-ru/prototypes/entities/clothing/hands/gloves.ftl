...
ent-ClothingHandsKnuckleDusters = кастеты
    .desc = Холодные пласталевые кастеты, делают ваши удары гораздо сильнее.
ent-ClothingHandsKnuckleDustersBrass = латунные кастеты
    .desc = Латунные кастеты, такие же, как раньше, и всё ещё бьют так же сильно.
ent-ClothingHandsKnuckleDustersQM = золотые кастеты Квартирмейстера
    .desc = 24-каратное золото, сплавленное с пласталью и клеймённое логотипом Nanotrasen. Истинный символ мощи Квартирмейстера.
ent-ClothingHandsKnuckleDustersSyndicate = кастеты синдиката
    .desc = Пластитановые кастеты, клеймённые кроваво-красной буквой S. Настоящий мужчина забивает ими кого-либо до смерти.
ent-ClothingHandsKnuckleDustersStun = оглушающие кастеты
    .desc = Пара кастетов, скомбинированных с технологией электрошоковой дубинки. Это значительно облегчает избиение "та́йдеров".
