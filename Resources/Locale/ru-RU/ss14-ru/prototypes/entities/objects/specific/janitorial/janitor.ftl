ent-MopItem = швабра
    .desc = Швабра, которую невозможно остановить, viscera cleanup detail ждет вас.
...
ent-GoldenPlunger = золотой вантуз
    .desc = Вантуз с пластиковым клапаном, покрытым тонким слоем золота, который выдается в благодарность за многолетнюю службу. Все так же используется для прочистки канализации.
ent-RagItem = тряпка
