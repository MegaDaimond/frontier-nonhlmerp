ent-BaseCargoPallet = грузовая поддон
    .desc = Обычное приспособление для логистики и грузоперевозок. Тонкое напоминание о том, куда помещать ящики во время транспортировки, чтобы избежать ушибов на мезинце.
