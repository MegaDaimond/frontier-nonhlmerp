...
ent-HoloprojectorField = проектор силового поля
    .desc = Создает непроходимое силовое поле, которое ничего не пропускает. Нахождение в непосредственной близости может вызвать рак, а может и не вызвать.
...
ent-HoloprojectorSecurity = проектор голобарьера
    .desc = Создает твердый но хрупкий барьер.
