...
ent-ScrapSteel = взорванная куча стали
    .desc = Груда стали, сваренная вместе при экстремальной жаре. В целом она приличного размера, из нее можно получить достаточное количество листов.
    .suffix = { ent-BaseScrap.suffix }
...
ent-ScrapCamera = сломанная камера
    .desc = Возможно, она все еще наблюдает..
    .suffix = { ent-BaseScrap.suffix }
...
ent-ScrapCloset = дверь шкафчика
    .desc = Снесенная дверь из технического шкафа. Выглядит как хороший настенный декор.
    .suffix = { ent-BaseScrap.suffix }
