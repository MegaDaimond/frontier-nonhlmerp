...
ent-PowerCellSmallNuclear = маломощная ядерная энергетическая ячейка
    .desc = Самозаряжающаяся энергетическая ячейка, разработанная для быстрой перезарядки за счёт ёмкости.
