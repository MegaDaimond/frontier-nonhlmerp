...
ent-BladedFlatcapGrey = серая плоская кепка
    .desc = В моде как у рабочего класса, так и у стариков навроде Дженкинса. Острый козырек скрывает битое стекло.
    .suffix = Лезвие
ent-BladedFlatcapBrown = коричневая плоская кепка
    .desc = Тупой клоун! Ты выставил меня в плохом свете! Острый козырек скрывает битое стекло.
