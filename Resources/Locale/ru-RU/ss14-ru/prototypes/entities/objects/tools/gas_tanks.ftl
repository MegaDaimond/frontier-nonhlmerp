...
ent-ExtendedEmergencyOxygenTank = аварийный кислородный баллон повышенной емкости
    .desc = Аварийный баллон повышенной емкости. Технически рассчитан на длительное использование. Вмещает 1,5 Л газа.
...
ent-EmergencyFunnyOxygenTank = веселый аварийный кислородный баллон
    .desc = Легкий переносной баллон для чрезвычайных ситуаций. Содержит очень мало кислорода и чуточку веселящего газа, предназначен только для выживания. Вмещает 0,66 Л газа.
