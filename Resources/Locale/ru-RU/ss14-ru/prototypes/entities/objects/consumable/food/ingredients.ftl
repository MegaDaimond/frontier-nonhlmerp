...
ent-FoodDoughRope = косичка теста
    .desc = Тонкая веревка теста. Может быть превращена в бублик.
...
ent-FoodDoughTortillaFlat = плоское тесто тортильи
    .desc = Расплющенный кусок теста тортильи. Приготовьте его, чтобы получить лепешку тако.
...
ent-FoodDoughCottonRope = косичка хлопкового теста
    .desc = Тонкая веревка хлопкового теста. Может быть превращена в хлопковый бублик.
...
ent-FoodCannabisButter = брусок конопляного масла
    .desc = Добавляйте это в свою любимую выпечку для веселого времяпровождения.
