...
ent-FoodBreadMeatSpider = хлеб из паучьего мяса
    .desc = Успокаивающе-зеленый рулет из мяса паука.
ent-FoodBreadMeatSpiderSlice = ломтик хлеба из паучьего мяса
    .desc = Кусок мясного рулета, приготовленного из животного, которое, скорее всего, все еще хочет вашей смерти.
...
ent-FoodBreadJellySlice = желейный тост
    .desc = Как будто ученые отдадут свои слаймов на тосты!
