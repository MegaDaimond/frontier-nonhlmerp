...
ent-WheatBushel = сноп пшеницы
    .desc = Как правило, не лишен здравого зерна.
...
ent-Log = бревно
    .desc = Такое заметишь и в своем глазу.
ent-SteelLog = бревно сталешляпника
    .desc = Сталь не растет на деревьях! Конечно, она растет как грибы.
ent-Nettle = крапива
...
ent-FoodSpacemansTrumpet = космонавтская труба
    .desc = Яркий цветок, слабо пахнущий свежескошенной травой. Кажется, что после прикосновения к нему на коже остается пятно, однако большинство других поверхностей не подвержены этому явлению.
