...
ent-FoodMeatDragon = плоть дракона
    .desc = Жесткое мясо хищника космической эры сочится мифическим ихором. По иронии судьбы, его лучше всего есть сырым.
...
ent-FoodMeatSalami = салями
    .desc = Большая трубка салями. Лучше не спрашивать, что в нее входит.
