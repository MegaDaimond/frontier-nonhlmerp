...
ent-DrinkMugMoebius = кружка мебиус
...
ent-DrinkHotCoffee = кружка кофе
    .desc = Кофе это напиток, который готовят из обжаренных зерен, обычно называемых кофейными зернами, с кофейного куста.
...
ent-DrinkGreenTea = чашка зеленого чая
    .desc = Простая белая фарфоровая чашка.
ent-DrinkLean = лин
    .desc = Бро, у Дрейка такая крутая прическа фейд, бро, Дрейк лучший, бро, давай, бро.
