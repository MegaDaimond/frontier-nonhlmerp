...
ent-PosterContrabandRealExomorph = Похотливая ксено дева
...
ent-PosterContrabandRouny = Вы его видели?
    .desc = Старый постер о пропавшем инопланетянине. Куда же он сбежал?
...
ent-PosterContrabandExoAcid = Экзоморф. Осторожно: кислотная слюна!
    .desc = Этот постер предупреждает об кислотной слюне экзоморфа. Не то чтобы такие экзоморфы существовали... Ведь так?
ent-PosterContrabandExoRun = Экзоморф. Осторожно: убегай!
    .desc = Этот постер предупреждает об атлетичном экзоморфе, способном утащить любого, кто попадётся; так что не попадайтесь!
ent-PosterContrabandExoChomp = Экзоморф. Осторожно: опасные укусы!
    .desc = Этот постер предупреждает о смертельных укусах, которыми могут обладать экзоморфы. Не станьте закуской для пришельцев!
