...
ent-PaintingEmpty = пустая рама
    .desc = Пустая рама, ожидающая, когда ее наполнят искусством.
...
ent-PaintingTheScream = Крик
    .desc = На этой картине изображен потрясенный мужчина, который стоит на мосту.
...
ent-PaintingSkeletonCigarette = Череп скелета с зажженной сигаретой
    .desc = На этой картине изображен импрессионистский портрет скелета. Зажженная сигарета зажата между его зубов.
ent-PaintingSkeletonBoof = Череп MLG скелета с толстым косяком
    .desc = Живопись дается с трудом. Не стесняйтесь делать скриншоты.
...
ent-PaintingOldGuitarist = Старый гитарист
    .desc = На этой картине изображен старый, худой человек, сжимающий в руках гитару. Его лицо выглядит осунувшимся и болезненным.
