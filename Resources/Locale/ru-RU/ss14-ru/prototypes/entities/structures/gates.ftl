...
ent-LogicGateOr = логический элемент
    .desc = Логический элемент с двумя портами на вход и одним на выход. Можно изменить логическую операцию с помощью отвертки.
    .suffix = Or, ИЛИ
...
ent-MemoryCell = ячейка памяти
    .desc = Схема D-триггер защелки, хранящая сигнал, который может быть изменен в зависимости от входного и разрешающего портов.
