...
ent-DisposalTagger = маркировщик утилизационной трубы
    .desc = Труба, маркирующая объекты для отправки определенному адресату.
...
ent-DisposalYJunction = Y-развязка утилизационной трубы
    .desc = Трехсторонняя развязка с альтернативным местом выхода.
...
ent-DisposalSignalRouter = сигнальный утилизационный маршрутизатор
    .desc = Трехсторонний маршрутизатор, управляемый сигналами.
