...
perishable-1 = [color=green]{ CAPITALIZE(OBJECT($target)) } тело выглядит еще свежим.[/color]
...
perishable-1-nonmob = [color=green]{ CAPITALIZE(SUBJECT($target)) } выглядит еще свежо.[/color]
