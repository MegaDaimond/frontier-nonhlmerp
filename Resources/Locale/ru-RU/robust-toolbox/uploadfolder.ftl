uploadfolder-command-description = Загружает папку из вашей папки UserData рекурсивно в contentDB сервера.
...
uploadfolder-command-resource-upload-disabled = Загрузка сетевых ресурсов в данный момент отключена. Проверьте CVar-ы сервера.
