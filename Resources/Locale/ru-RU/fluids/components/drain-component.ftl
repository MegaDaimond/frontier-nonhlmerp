...
drain-component-examine-hint-full = [color=cyan]Заполнено до краев. Может, вантуз поможет?[/color]
drain-component-examine-volume = [color=cyan]Доступный объем - { $volume } ед.[/color]
drain-component-unclog-fail = Устройство { $object } все еще переполнено.
