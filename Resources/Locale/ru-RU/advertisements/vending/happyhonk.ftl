...
advertisement-happyhonk-3 = Если вы найдете золотой хонкер, то помолитесь богам — вы счастливчик.
...
advertisement-happyhonk-7 = Хэппи Хонк не несет ответственности за качество продуктов, помещенных в наши коробки для обедов Хэппи Хонк.
