nuke-component-cant-anchor-floor = Крепежным болтам не удается закрепиться в полу!
nuke-component-cant-anchor-toggle = Для переключения крепежных болтов требуется диск ядерной аутентификации!
