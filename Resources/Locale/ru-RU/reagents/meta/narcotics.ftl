...
reagent-desc-experimental-stimulants = Опытная версия гиперзина. Ее использование дает практически полную невосприимчивость к оглушающему оружию, ускоренную регенерацию ран, огромную скорость передвижения за счет понижения выработки молочной кислоты и общее чувство эйфории. Среди побочных эффектов можно выделить низкую свертываемость крови, тоннельное зрение, сильное скопление токсинов в кровеносной системе и быстрое отмирание печени. Беречь от животных.
...
reagent-desc-happiness = Доводит до экстатического оцепенения и вызывает легкие повреждения мозга. Легко вызывает привыкание. Передозировка вызывает резкие перепады настроения.
