...
signal-linker-component-max-connections-receiver = Достигнут максимум соединений для приемника!
...
signal-linking-verb-disabled-no-receiver = Сначала вам необходимо взаимодействовать с приемником, затем соедините со стандартным портом.
