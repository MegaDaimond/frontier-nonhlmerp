...
pointing-system-point-in-own-inventory-others = { CAPITALIZE(THE($pointer)) } указывает на { THE($pointer) } { $item }.
pointing-system-point-in-other-inventory-self = Вы указываете на { THE($wearer) } { $item }.
pointing-system-point-in-other-inventory-target = { CAPITALIZE(THE($pointer)) } указывает на ваш { $item }.
pointing-system-point-in-other-inventory-others = { CAPITALIZE(THE($pointer)) } указывает на { THE($wearer) } { $item }.
