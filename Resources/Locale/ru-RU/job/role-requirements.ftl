role-timer-department-insufficient = Требуется еще [color=yellow]{ $time }[/color] минут игры за [color={ $departmentColor }]{ $department }[/color].
...
role-timer-overall-insufficient = Требуется еще [color=yellow]{ $time }[/color] минут общего игрового времени.
...
role-timer-role-insufficient = Требуется еще [color=yellow]{ $time }[/color] минут игры в качестве [color={ $departmentColor }]{ $job }[/color] для этой роли.
