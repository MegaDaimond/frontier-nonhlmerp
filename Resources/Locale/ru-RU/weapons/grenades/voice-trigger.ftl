...
popup-trigger-voice-record-failed-too-long = Слишком длинное сообщение, попробуйте еще раз
popup-trigger-voice-record-failed-too-short = Слишком короткое сообщение, попробуйте еще раз
