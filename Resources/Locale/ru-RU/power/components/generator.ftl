...
portable-generator-verb-start-msg-unanchored = Генератор должен быть закреплен!
portable-generator-verb-stop = Остановить генератор
portable-generator-start-fail = Вы дергаете за трос, но он не заводится.
portable-generator-start-success = Вы дергаете за трос, и он оживает.
