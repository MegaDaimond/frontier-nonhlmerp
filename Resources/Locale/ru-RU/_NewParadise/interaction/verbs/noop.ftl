...
interaction-LPPFuckYou-description = Покажите своё желание послать кого-то этим действием.
...
interaction-LPPSlap-description = Как насчёт оставить след на чужой щеке?
...
interaction-LPPSlap2-success-target-popup = { THE($user) } наносит вам лёгкий шлепок.
interaction-LPPSlap2-success-others-popup = { THE($user) } наносит лёгкий шлепок { THE($target) }.
