...
game-ticker-get-info-preround-text =
    ...
    Текущий режим игры: [color=white]{ $gmTitle }[/color]
    >[color=yellow]{ $desc }[/color]
game-ticker-no-map-selected = [color=red]Карта еще не выбрана![/color]
...
player-join-message = Игрок { $name } зашел!
player-first-join-message = Игрок { $name } зашел на сервер впервые.
