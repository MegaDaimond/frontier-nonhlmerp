...
using Content.Server.Database; // LUA edit
...
using System.Threading.Tasks; // LUA edit
using Content.Shared._NF.Bank.Events;
using Content.Shared.GameTicking;
using Robust.Shared.Network; // LUA edit
...
public sealed partial class BankSystem : SharedBankSystem
{
    ...
    [Dependency] private readonly IServerDbManager _db = default!; // LUA edit
